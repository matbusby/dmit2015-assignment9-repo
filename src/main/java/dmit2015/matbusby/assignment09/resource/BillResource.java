...
public class BillResource {
    ...
    /**
     * curl -i -X POST http://localhost:8080/webapi/Bills \
     *  -d '{"payeeName":"Jamie","dueDate":"2020-12-22","amountDue":100.00}' \
     *  -H 'Content-Type:application/json'
     *
     * curl -i -X GET http://localhost:8080/webapi/Bills/
     *
     * curl -i -X GET http://localhost:8080/webapi/Bills/3
     *
     * curl -i -X DELETE http://localhost:8080/webapi/Bills/5
     *
     * */
